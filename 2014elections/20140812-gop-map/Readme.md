# Star Tribune - Who Will Control the Minnesota House of Representatives?
...
1. Get code and enter project: `git clone https://github.com/striblab/20140812-gop-map.git && cd 20140812-gop-map.git`
...
2. Copy files (update path as needed): `mkdir -p ../20140812-gop-map/ && rsync -rav ./ ../20140812-gop-map/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
