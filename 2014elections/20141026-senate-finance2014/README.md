# Star Tribune - 2014 MN Senate Race Fundraising
...
1. Get code and enter project: `git clone https://github.com/striblab/20141026-senate-finance2014.git && cd 20141026-senate-finance2014.git`
...
2. Copy files (update path as needed): `mkdir -p ../20141026-senate-finance2014/ && rsync -rav ./ ../20141026-senate-finance2014/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
