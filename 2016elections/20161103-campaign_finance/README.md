# Star Tribune - Minnesota legislative campaign finance
...
1. Get code and enter project: `git clone https://github.com/striblab/20161103-campaign_finance.git && cd 20161103-campaign_finance.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161103-campaign_finance/ && rsync -rav ./ ../20161103-campaign_finance/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
