# Star Tribune Battleground Minnesota 2016 - 13 takeaways from the 2016 presidential election in Minnesota, nationwide
...
1. Get code and enter project: `git clone https://github.com/striblab/20161111-pomo_mnflips.git && cd 20161111-pomo_mnflips.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161111-pomo_mnflips/ && rsync -rav ./ ../20161111-pomo_mnflips/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
