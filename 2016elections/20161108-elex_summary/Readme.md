# Star Tribune Battleground Minnesota 2016 - Election Night Homepage Module
...
1. Get code and enter project: `git clone https://github.com/striblab/20161108-elex_summary.git && cd 20161108-elex_summary.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161108-elex_summary/ && rsync -rav ./ ../20161108-elex_summary/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
