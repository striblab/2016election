# Star Tribune - 2016 Minnesota Caucus Results
...
1. Get code and enter project: `git clone https://github.com/striblab/20160303-mncaucus.git && cd 20160303-mncaucus.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160303-mncaucus/ && rsync -rav ./ ../20160303-mncaucus/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
