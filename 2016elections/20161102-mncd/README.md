# Star Tribune - Battle for Minnesota's congressional seats
...
1. Get code and enter project: `git clone https://github.com/striblab/20161102-mncd.git && cd 20161102-mncd.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161102-mncd/ && rsync -rav ./ ../20161102-mncd/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
