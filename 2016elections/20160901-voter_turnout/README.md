# Star Tribune - Minnesota Historical Voter Turnout
...
1. Get code and enter project: `git clone https://github.com/striblab/20160901-voter_turnout.git && cd 20160901-voter_turnout.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160901-voter_turnout/ && rsync -rav ./ ../20160901-voter_turnout/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
