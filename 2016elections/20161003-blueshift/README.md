# Star Tribune - Could Minnesota become a battleground state?
...
1. Get code and enter project: `git clone https://github.com/striblab/20161003-blueshift.git && cd 20161003-blueshift.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161003-blueshift/ && rsync -rav ./ ../20161003-blueshift/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
