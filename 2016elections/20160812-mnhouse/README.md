# Star Tribune - Battle for the Minnesota House
...
1. Get code and enter project: `git clone https://github.com/striblab/20160812-mnhouse.git && cd 20160812-mnhouse.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160812-mnhouse/ && rsync -rav ./ ../20160812-mnhouse/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
