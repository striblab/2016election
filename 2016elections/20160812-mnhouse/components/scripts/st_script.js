...
// d3.json("http://googlescript.startribune.com/?macro=AKfycbwG7mX6qPZaIhkwY2AJ2lU7kNarbm6OWIkWVfnmYZGYruIl40cu&id=17N3mrwSRe6BJScRby9auxtQ8o7UwhfXv2IuTxbmlakY&sheet=mnleg_chatter", function(error, dataLoadC) {
...
$(".chatterBox, #mChatter").html("<div class='chartTitle'>" + dataChatter[0].headline + "</div><div class='chatter'>" + dataChatter[0].chatter + "</div>");
...
.data(data.filter(function(d){ return d.lean == rank && d.chamber == "house"; }).sort(function(a, b) { return d3['ascending'](a.district, b.district); })).enter().append("div")
...
.call(d3.helper.tooltip(function(d, i){
        if (d.district == "03A") { var yearWin = "2015 WIN"; }
      else { var yearWin = "2014 WIN"; }
        if (d.party == "GOP") { 
        if  (d.PCT2014 > 80) { return "<div><strong>District " + d.district + "</strong></div><div>" + d.candidate + "</div><div class='r4'>" +  Math.round(d.PCT2014) + "% " + yearWin + "</div>"; }
        else if  (d.PCT2014 > 70) { return "<div><strong>District " + d.district + "</strong></div><div>" + d.candidate + "</div><div class='r3'>" +  Math.round(d.PCT2014) + "%  " + yearWin + "</div>"; }
        else if  (d.PCT2014 > 60) { return "<div><strong>District " + d.district + "</strong></div><div>" + d.candidate + "</div><div class='r2'>" +  Math.round(d.PCT2014) + "%  " + yearWin + "</div>"; }
        else if  (d.PCT2014 > 50) { return "<div><strong>District " + d.district + "</strong></div><div>" + d.candidate + "</div><div class='r1'>" +  Math.round(d.PCT2014) + "%  " + yearWin + "</div>"; }
      }
      else if (d.party == "DFL") { 
        if  (d.PCT2014 > 80) { return "<div><strong>District " + d.district + "</strong></div><div>" + d.candidate + "</div><div class='d4'>" +  Math.round(d.PCT2014) + "%  " + yearWin + "</div>"; }
        else if  (d.PCT2014 > 70) { return "<div><strong>District " + d.district + "</strong></div><div>" + d.candidate + "</div><div class='d3'>" +  Math.round(d.PCT2014) + "%  " + yearWin + "</div>"; }
        else if  (d.PCT2014 > 60) { return "<div><strong>District " + d.district + "</strong></div><div>" + d.candidate + "</div><div class='d2'>" +  Math.round(d.PCT2014) + "%  " + yearWin + "</div>"; }
        else if  (d.PCT2014 > 50) { return "<div><strong>District " + d.district + "</strong></div><div>" + d.candidate + "</div><div class='d1'>" +  Math.round(d.PCT2014) + "%  " + yearWin + "</div>"; }
      }
}));
...
// d3.select(container).selectAll(".box").data(data.sort(function(a, b) { return d3['ascending'](a.district, b.district); })).transition().duration(750);
  ...
  d3.select(container).html("");
d3.select(container).selectAll(".box")
.data(data.filter(function(d){ return d.party == rank && d.chamber == "house"; }).sort(function(a, b) { return d3['ascending'](a.PCT2014, b.PCT2014); })).enter().append("div")
.attr("id", function (d) { return "d" + d.district; })
.attr("class",function (d){ 
      if (d.party == "GOP") { 
        if  (d.PCT2014 > 70) { var color =  "r3"; }
...
// $(container).parent().append("<div class='breaker'></div>");
 ...
 d3.select(container).selectAll(".box").data(data).exit().remove();
d3.select(container).selectAll(".box")
.data(data.filter(function(d){ return d.party == rank && d.chamber == "house"; })).enter().append("div")
.attr("id", function (d) { return "d" + d.district; })
.attr("class",function (d){ 
      if (d.party == "GOP") { 
        var color =  "r3";
...
// $(container).parent().append("<div class='breaker'></div>");
  ...
  d3.select(container).html("");
d3.select(container).selectAll(".box")
.data(data.filter(function(d){ return d.party == rank && d.chamber == "house"; }).sort(function(a, b) { return d3['ascending'](a.district, b.district); })).enter().append("div")
.attr("id", function (d) { return "d" + d.district; })
.attr("class",function (d){ 
      if (d.party == "GOP") { 
        var color =  "r3";
...
.data(data.filter(function(d){ return d.chamber == "house"; }).sort(function(a, b) { return d3['ascending'](a.district, b.district); })).enter().append("div")
...
var chart = c3.generate({
    ...
    data: {
        x: 'x',
        columns: [
            ['x',2002,2004,2006,2008,2010,2012,2014],
            ['DFL Seats',52,66,85,87,62,73,62],
            ['GOP Seats',81,68,49,47,72,61,72]
        ],
        type: 'line'
    },
    legend: {
    ...
    axis: {
      y: {
        ...
        x: {
            tick: {
                values: ['2002', '2004', '2008', '2012', '2014'],
                count: 5,
                multiline: false
            },
            padding: {
...
for (var i=0; i < data.length; i++){
  if (data[i].district == district && data[i].chamber == "house"){
    // dflPCT[1] = data[i].DFL2002 / 100;
    dflPCT[1] = data[i].DFL2004 / 100;
    dflPCT[2] = data[i].DFL2006 / 100;
    dflPCT[3] = data[i].DFL2008 / 100;
    dflPCT[4] = data[i].DFL2010 / 100;
    dflPCT[5] = data[i].DFL2012 / 100;
    dflPCT[6] = data[i].DFL2014 / 100;
    // GOPPCT[1] = data[i].GOP2002 / 100;
    GOPPCT[1] = data[i].GOP2004 / 100;
    GOPPCT[2] = data[i].GOP2006 / 100;
    GOPPCT[3] = data[i].GOP2008 / 100;
    GOPPCT[4] = data[i].GOP2010 / 100;
    GOPPCT[5] = data[i].GOP2012 / 100;
    GOPPCT[6] = data[i].GOP2014 / 100;
  }
}
...
function mapColor(d, race, dataCompare){
  ...
  for (var i=0; i < dataCompare.length; i++){
    if (dataCompare[i].district == d && dataCompare[i].chamber == "house"){
...
function mapTips(d, subject, dataCompare){
    if (subject == "house"){
      if (d.properties.DISTRICT == "03A") { var yearWin = "2015 WIN"; }
      else { var yearWin = "2014 WIN"; }
    for (var i=0; i < dataCompare.length; i++){
    if (dataCompare[i].district == d.properties.DISTRICT && dataCompare[i].chamber == "house"){
      if (dataCompare[i].party == "GOP") { 
        if  (dataCompare[i].PCT2014 > 80) { return "<div><strong>District " + d.properties.DISTRICT + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='r4'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 > 70) { return "<div><strong>District " + d.properties.DISTRICT + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='r3'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 > 60) { return "<div><strong>District " + d.properties.DISTRICT + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='r2'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 > 50) { return "<div><strong>District " + d.properties.DISTRICT + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='r1'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
      }
      else if (dataCompare[i].party == "DFL") { 
        if  (dataCompare[i].PCT2014 > 80) { return "<div><strong>District " + d.properties.DISTRICT + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='d4'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 > 70) { return "<div><strong>District " + d.properties.DISTRICT + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='d3'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 > 60) { return "<div><strong>District " + d.properties.DISTRICT + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='d2'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 > 50) { return "<div><strong>District " + d.properties.DISTRICT + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='d1'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
      }
    }
...
d3.selectAll(container + " svg g path")
  ...
  for (var i=0; i < dataCompare.length; i++){
   ...
   return "mid";
    ...
    for (var i=0; i < dataCompare.length; i++){
      if (d.properties.DISTRICT == dataCompare[i].district && dataCompare[i].chamber == "house"){
...
$('.statNum').removeClass("gray5, gray4, gray3, gray2, gray1");
    ...
    var num = $(this).text();
      if (num >= .80) { $(this).addClass("gray5"); $(this).html(d3.format("%")(num)); }
           ...
           .call(d3.helper.tooltip(function(d, i){
      if (d.state_postal == "03A") { var yearWin = "2015 WIN"; }
      else { var yearWin = "2014 WIN"; }
            for (var i=0; i < dataCompare.length; i++){
  if (dataCompare[i].district == d.state_postal){
      if (dataCompare[i].party == "GOP") { 
        if  (dataCompare[i].PCT2014 >= 80) { return "<div><strong>" + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='r4'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 >= 70) { return "<div><strong>" + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='r3'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 >= 60) { return "<div><strong>" + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='r2'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 >= 50) { return "<div><strong>District " + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='r1'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
      }
      else if (dataCompare[i].party == "DFL") { 
        if  (dataCompare[i].PCT2014 >= 80) { return "<div><strong>" + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='d4'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 >= 70) { return "<div><strong>" + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='d3'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 >= 60) { return "<div><strong>" + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='d2'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 >= 50) { return "<div><strong>" + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='d1'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
      }
    }
  }
            }));
...
$('.statNum').removeClass("gray5, gray4, gray3, gray2, gray1");
  ...
  if (dataCompare[i].district == d.state_postal){
      if (dataCompare[i].party == "GOP") { 
        ...
        else if  (dataCompare[i].PCT2014 >= 50) { return "<div><strong>" + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='r1'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
      }
      else if (dataCompare[i].party == "DFL") { 
        if  (dataCompare[i].PCT2014 >= 80) { return "<div><strong>" + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='d4'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
        else if  (dataCompare[i].PCT2014 >= 70) { return "<div><strong>" + d.state_full + "</strong></div><div>" + dataCompare[i].candidate + " (" + dataCompare[i].party + ")" + "</div><div class='d3'>" +  Math.round(dataCompare[i].PCT2014) + "% " + yearWin + "</div>"; }
...
d3.selectAll(container + " svg rect")
  ...
  for (var i=0; i < dataCompare.length; i++){
   ...
   return "mid";
    ...
    for (var i=0; i < dataCompare.length; i++){
      if (d.state_postal == dataCompare[i].district){
    if (dataCompare[i].HotDistrict == "x"){
...
$(".step").click(function() {
  ...
  $(".maps").hide();
  $("#" + $(this).attr("view")).show();
  mapReshade("#mapState", "mnleg.json", $(this).attr("data"), "house", data);
  mapReshade("#mapMetro", "mnleg_metro.json", $(this).attr("data"), "house", data);
  cartoReshade("#cartoState", "mnleg.json", $(this).attr("data"), "house", data, cartoData("mnhouse","mn"));
  cartoReshade("#cartoMetro", "mnleg_metro.json", $(this).attr("data"), "house", data, cartoData("mnhouse","metro"));
  ...
  mapBuild("#mapMetro", "#infobox", "#chart", "mnleg_metro.json", "house", "metro", data, 0);
  mapBuild("#mapState", "#infobox", "#chart", "mnleg.json", "house", "mn", data, 0);
  ...
  $("#dStrongCount").html(61);
  $("#dLeanCount").html(0);
  $("#tossupCount").html(0);
  $("#rLeanCount").html(0);
  $("#rStrongCount").html(73);
  ...
  $(".half.d0").css({"width":"45%",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.d0").attr("title","61 seats");
  $(".half.d2").css({"width":"0",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
  ...
  $(".half.r2").css({"width":"0",
    ...
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.r0").css({"width":"54%",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.d0").attr("title","73 seats");
 ...
 $(".column").css({"display":"block",
  ...
  $(".half.d0").css({"width":"14%",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.d0").attr("title","19 seats");
  $(".half.d2").css({"width":"13%",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.d2").attr("title","17 seats");
  $(".half.d1").css({"width":"18%",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.d1").attr("title","26 seats");
  $(".half.mid").css({"width":"0",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
  ...
  $(".half.r1").css({"width":"22%",
    ...
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.r1").attr("title","36 seats");
  $(".half.r2").css({"width":"26%",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.r2").attr("title","29 seats");
  $(".half.r0").css({"width":"6%",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
  ...
  $(".half.mid").css({"width":"16%",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.mid").attr("title","22 seats");
  $(".half.r1").css({"width":"13%",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.r1").attr("title","11 seats");
  $(".half.r2").css({"width":"0",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.r2").attr("title","0%");
  $(".half.r0").css({"width":"31%",
    WebkitTransition : 'width 0.3s ease-in-out',
    MozTransition    : 'width 0.3s ease-in-out',
    MsTransition     : 'width 0.3s ease-in-out',
    OTransition      : 'width 0.3s ease-in-out',
    transition       : 'width 0.3s ease-in-out'});
  $(".half.r0").attr("title","45 seats");
...
$(".column").css({"display":"inline-block",
  ...
  maths("current",true);
  cartoBuild("#cartoState", "#infobox", "#chart", null, "mnhouse", data, "mn", 0, cartoData("mnhouse","mn"));
  cartoBuild("#cartoMetro", "#infobox", "#chart", null, "mnhouse", data, "metro", 1, cartoData("mnhouse","metro"));
...
function getCandidates(district, party){
  var first, last, city, party, chamber, endcash, indcontrib, ppcontrib, pfcontrib, lbcontrib;
    for (var i=0; i < dataFilings.length; i++){
      if (String(dataFilings[i].district) == String(district) && dataFilings[i].party == party){
