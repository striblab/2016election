# Star Tribune - Minnesota early voting trends
...
1. Get code and enter project: `git clone https://github.com/striblab/20161107-early_voting.git && cd 20161107-early_voting.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161107-early_voting/ && rsync -rav ./ ../20161107-early_voting/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
