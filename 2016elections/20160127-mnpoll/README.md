...
1. Get code and enter project: `git clone https://github.com/striblab/20160127-mnpoll.git && cd 20160127-mnpoll.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160127-mnpoll/ && rsync -rav ./ ../20160127-mnpoll/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
