# Star Tribune - Minnesota presidential poll tracker
...
1. Get code and enter project: `git clone https://github.com/striblab/20161025-pollster.git && cd 20161025-pollster.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161025-pollster/ && rsync -rav ./ ../20161025-pollster/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
