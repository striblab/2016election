# Star Tribune Battleground Minnesota 2016 - Live election results
...
1. Get code and enter project: `git clone https://github.com/striblab/20161108-battleground.git && cd 20161108-battleground.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161108-battleground/ && rsync -rav ./ ../20161108-battleground/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
