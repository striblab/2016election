...
1. Get code and enter project: `git clone https://github.com/striblab/20161204-mnhouse_pomo.git && cd 20161204-mnhouse_pomo.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161204-mnhouse_pomo/ && rsync -rav ./ ../20161204-mnhouse_pomo/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
