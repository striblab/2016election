...
Detailed precinct voting maps for major mayoral candidates in Minneapolis and St. Paul.
...
```html
<div data-pym-src="http://static.startribune.com/projects/20171108-precincts">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20171108-precincts/",
      "url": "http://static.startribune.com/news/projects-staging/all/20171108-precincts/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20171108-precincts/",
      "url": "http://static.startribune.com/news/projects/all/20171108-precincts/"
    }
  }
}
```
